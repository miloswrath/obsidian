![[2026-02-23 2026-02-26 12.45.36.excalidraw]]
## Meetings
---
...
- **TOPIC / QUESTION:** What are the emerging ways that businesses are utilizing AI in both technical and non-technical areas of their organization. What tools and frameworks are the most popular at this time
- **GOAL TYPE (pick 1):** explain  
- **SCOPE:** Include ai use-cases and tools/frameworks exclude ads 
- **RECENCY WINDOW:** last 2 months
- **SOURCE QUALITY BAR (ranked):**  major journalism > vendor docs > reputable blogs > forums
- **ALLOWED SOURCE TYPES:** academic papers | official docs | standards | news | blogs | forums
- **MIN # OF INDEPENDENT SOURCES:** 10
- **OUTPUT FORMAT:** bullets, memo, & table 
